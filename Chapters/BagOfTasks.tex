...
\lhead{Chapter 4. \emph{Bag of tasks optimization}}
...
\subsection{Formulation of constraints and objectives}
  ...
  \begin{itemize}
      ...
      implements $\HasTail_i = \left\{\begin{array}{cc} 1 & \TailTaskHours_i\; >\; 0 \\ 0 & \TailTaskHours_i\; =\; 0 \end{array}\right.$. %TODO
...
\label{sec:bot:private-infinite} 
  ...
  \begin{figure}[tb] 
     \centering
     \includegraphics[width=\columnwidth]{results/infinite/small/graph-small-infinite.pdf}
  ...
  \begin{figure}[tb] 
     \centering
     \includegraphics[width=\columnwidth]{results/infinite/large/graph-large-infinite.pdf}
...
\label{sec:bot:private-finite}
  ...
  \begin{figure}[tb]
     \centering
     \includegraphics[width=\columnwidth]{results/finite/small/graph-small-finite.pdf}
  ...
  \begin{figure}[tb]
     \centering
     \includegraphics[width=\columnwidth]{results/finite/large/graph-large-finite.pdf}
...
\label{sec:overlapping}
  ...
  Fig.~\ref{fig:large-finite-overlap} shows results for the same experiment as in Section~\ref{sec:private-finite} and Fig.~\ref{fig:large-finite}, but with computing and transfers overlapping. Overlapping reduces total cost as time required for task processing is significantly lower.  This is especially true for shorter deadlines when multiple  clouds are used, as transfer rates are lower between different clouds comparing to one provider infrastructure.
...
\label{sec:special}
  ...
  \begin{figure}[tb]
     \centering 
   \subfloat[Deadline = 9 hours \label{fig:special-case-009-cf}]{
     \includegraphics[width=\columnwidth]{BagOfTasks/special-case-009-cf.pdf}
     }\\
     \subfloat[Deadline = 10 hours \label{fig:special-case-010-cf}]{
     \includegraphics[width=\columnwidth]{BagOfTasks/special-case-010-cf.pdf}
     }
...
\label{sec:bot:sensitivity}
  ...
  Fig.~\ref{fig:cost_vs_data_size} presents these results from a perspective
  where each curve shows how the cost depends on data size for varying
  deadlines.
  
  \begin{figure}[tb]
     \centering \subfloat[Cost as a function of deadline]{
     \includegraphics[width=\columnwidth]{BagOfTasks/deadline-cost-150}
     }\\
     \subfloat[Elasticity of cost versus deadline]{
     \includegraphics[width=\columnwidth]{BagOfTasks/deadline-elasticity-150} }
