...
\label{sec:bot:private-infinite} 
  ...
  \begin{figure}[tb] 
     \centering
     \includegraphics[width=\columnwidth]{BagOfTasks/graph-small-infinite.pdf}
  ...
  \begin{figure}[tb] 
     \centering
     \includegraphics[width=\columnwidth]{BagOfTasks/graph-large-infinite.pdf}
...
\label{sec:bot:private-finite}
  ...
  \begin{figure}[tb]
     \centering
     \includegraphics[width=\columnwidth]{BagOfTasks/graph-small-finite.pdf}
  ...
  \begin{figure}[tb]
     \centering
     \includegraphics[width=\columnwidth]{BagOfTasks/graph-large-finite.pdf}
...
\label{sec:special}
  ...
  \begin{figure}[tb]
     \centering 
     \subfigure[Deadline = 9 hours \label{fig:special-case-009-cf}]{
       \includegraphics[width=\columnwidth]{BagOfTasks/special-case-009-cf.pdf}
     } \\
     \subfigure[Deadline = 10 hours \label{fig:special-case-010-cf}]{
...
\label{sec:bot:sensitivity}
  ...
  \begin{figure}[tb]
     \centering \subfigure[Cost as a function of deadline]{
     \includegraphics[width=\columnwidth]{BagOfTasks/deadline-cost-150}
     }\\
     \subfigure[Elasticity of cost versus deadline]{
