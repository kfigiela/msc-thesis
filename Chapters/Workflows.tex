...
%         \item(\ref{cLayerTime}) bind that $\LayerDeadline = \ceil{\LayerTime}$,
...
%         \item(\ref{cEnoughProcessingPower}) adjust $\InstanceHours$ respectively to $\InstanceTasks$,
...
%         \item(\ref{cProviderLimits}) enforces providers' instance limits. 
%     \end{itemize}
%     
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
          \item $\forall_{t \in \TASK, i \in \INSTANCE, x \in \left\{1 .. \left(\instanceMaxMachines_i - 1\right)\right\}}  
                 \InstanceHours_{t,i,x} \leq \InstanceHours_{t,i,x-1}$,        
          \item $\forall_{t \in \TASK, i \in \INSTANCE, x \in \left\{1 .. \left(\instanceMaxMachines_i - 1\right)\right\}}  
                 \InstanceActive_{t,i,x} \leq \InstanceActive_{t,i,x-1}$, and: 
          \item $\forall_{t \in \TASK, i \in \INSTANCE, x \in \left\{1 .. \left(\instanceMaxMachines_i - 1\right)\right\}} 
                \InstanceTasks_{t,i,x} \leq \InstanceTasks_{t,i,x-1} $.
        \end{enumerate}
    ...
    \begin{figure}[b] 
       \centering
       \subfigure[400 tasks, 1 GiB data size \label{fig:genome-400}]{
         \includegraphics[width=0.49\textwidth]{Workflow/Genome400-deadline_cost}
       }
       \subfigure[500 tasks, 4 GiB data size \label{fig:genome-500}]{
         \includegraphics[width=0.49\textwidth]{Workflow/Genome500-deadline_cost}
       }
    ...
    \begin{figure}[tb]
       \centering \includegraphics[width=0.49\textwidth]{Workflow/Genome500-time_ratio}
    ...
    \begin{figure}[tb] 
       \centering
       \subfigure[CyberShake, 500 tasks\label{fig:cybershake-500}]{
         \includegraphics[width=0.49\linewidth]{Workflow/CYBERSHAKE-500-deadline_cost}
       }
       \subfigure[LIGO, 500 tasks\label{fig:ligo-500}]{
         \includegraphics[width=0.49\linewidth]{Workflow/LIGO-500-deadline_cost}
       } \\
       \subfigure[Montage, 500 tasks\label{fig:montage-500}]{
         \includegraphics[width=0.49\linewidth]{Workflow/MONTAGE-500-deadline_cost}
       } 
%        \subfigure[SIPHT, 500 tasks\label{fig:sipht-500}]{
%          \includegraphics[width=0.49\textwidth]{Workflow/SIPHT-500-deadline_cost}
%        }
       \subfigure[SIPHT, 5000 tasks\label{fig:sipht-5000}]{
         \includegraphics[width=0.49\linewidth]{Workflow/SIPHT-5000-deadline_cost}
       }
    ...
    \begin{figure}[tb]
       \centering \includegraphics[width=\textwidth]{Workflow/MONTAGE-500x1000-deadline_cost}
    ...
    \begin{figure}[tb] 
       \centering
       \subfigure[Epigenomics, 600 tasks \label{fig:genome-600-opttime}]{
         \includegraphics[width=\linewidth]{Workflow/Genome600-wall_time}
       }
       \subfigure[SIPHT, 5000 tasks \label{fig:sipht-5000-opttime}]{
