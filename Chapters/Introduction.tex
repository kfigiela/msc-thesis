...
In this chapter we discussed the motivation an goals of this work. We given a brief overview on scientific applications focusing on bag of tasks applications and workflows. We also got introduced cloud computing. We will go deep into the IaaS cloud characteristics in Section~\ref{sec:bot:cloudmodel}.
