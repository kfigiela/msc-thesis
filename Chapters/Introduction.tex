...
Depending on who manages cloud infrastructure we may distinguish a few models:
...
Scientific applications may be divided into a few groups: 
\begin{itemize}
  \item workflows,
  \item bag of tasks,
  \item map\-reduce,  
