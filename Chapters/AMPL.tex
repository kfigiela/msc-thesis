...
To get some practise with modelling, we will describe a typical linear programming problem on the example of \emph{Whiskas Cat Food problem}. This is typical planning problem that may be found in many textbooks~\cite{dantzig}. The company producing the food wants to produce it as cheaply as possible while ensuring they meet the stated nutritional analysis requirements stated on the cans. 
