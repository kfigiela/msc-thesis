...
The results illustrate typical problems when making decisions on deployment planning on clouds and how they can be addressed using optimization techniques. We indicate how optimization of resource allocation may be used by end-user or a reseller for a profit.
